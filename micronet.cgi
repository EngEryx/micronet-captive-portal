...
<body bgColor = '#ffffff'>";
  print "<h1 style=\"text-align: center;\">Logging in to Eryx Labs</h1>";
  print "
  <center>
    Please wait......
  </center>
...
<body bgColor = '#ffffff'>
  <h1 style=\"text-align: center;\">Eryx Labs Login Failed</h1>
  <center>
    Login must be performed through Eryx Labs daemon.
  </center>
</body>
</html>
";
...
if ($result == 5) {
    print "
  <h1 style=\"text-align: center;\">Eryx Labs Login</h1>";
}
...
if ($result == 1) {
  print "
  <h1 style=\"text-align: center;\">Logged in to Eryx Labs</h1>";
...
if (($result == 3) || ($result == 13)) {
    print "
  <h1 style=\"text-align: center;\">Logged out from Eryx Labs</h1>
  <center>
